...
const PlanPage = ({ planGroups, planForm, setPlanForm, currentRole, submittedPlans, setSubmittedPlans, onSubmitAll, onNotificationChange }) => {
  ...
  <div className="space-y-6">
    <div ref={headerRef} className="scroll-animate visible">
      <div className="mb-2">
        <h1 className="text-3xl font-bold text-gray-900">Input Rencana Kegiatan</h1>
        <p className="text-sm text-gray-500 mt-1">{new Date().toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
      </div>
    </div>
    <div ref={formRef} className="scroll-animate bg-white rounded-lg shadow-sm p-6 border border-gray-200">
