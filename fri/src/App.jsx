      ...
      <div className="flex min-h-screen">
        ...
        <main className="flex-1 min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
          ...
          <div className="flex items-center justify-between mb-6 gap-4">
            <div className="flex-1 max-w-md">
              <div className="relative">
                <input
                  ...
                  onKeyPress={(e) => {
                    if (e.key === 'Enter') {
                      // Perform search - bisa diimplementasikan lebih lanjut
                      console.log('Searching for:', searchQuery);
                    }
                  }}
                  className="w-full pl-10 pr-10 py-2.5 bg-white border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                />
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="hidden sm:flex items-center gap-3 px-3 py-2 bg-white rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors cursor-pointer"
              >
                <div className="w-8 h-8 bg-emerald-100 rounded-full flex items-center justify-center">
                  <span className="text-emerald-600 text-xs font-semibold">{currentRole.charAt(0).toUpperCase()}</span>
                </div>
          ...
          {activeSection === 'profile' && (
            <ProfilePage currentRole={currentRole} />
          )}
        </main>
      </div>
